enrollment <- list.files("1_raw_data/enrollment/", full.names = T, pattern = "csv") %>% 
...
fwrite(enrollment, "4_tidy_data/enrollment.csv")
rm(enrollment)

unlink("1_raw_data/enrollment/", recursive = T)
